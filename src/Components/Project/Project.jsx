      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-between gap-5 md:gap-7 lg:gap-10  max-w-7xl mx-auto my-10">
        <div className=" p-5 border rounded-lg space-y-4 ">
          ...
          <h3 className="text-2xl">
            EchoJournal: Hub for Reading and Sharing Articles
          </h3>
        ...
        <div className=" p-5 border rounded-lg space-y-4 ">
          ...
          <h3 className="text-2xl">
            FoodVilla: Your One-Stop Platform for Purchasing and Sharing
            Delicious Foods
          </h3>
          <p className=" text-justify">
        ...
        <div className=" p-5 border rounded-lg space-y-4 ">
          ...
          <h3 className="text-2xl">
            PotteryVerse: Your Marketplace for Unique Art and Craft Creations
          </h3>
          <p className=" text-justify">
